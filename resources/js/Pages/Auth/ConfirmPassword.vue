        ...
        <div class="relative mx-auto flex min-h-screen max-w-6xl items-center px-4 py-8 sm:px-6 lg:px-8">
            <div class="grid w-full overflow-hidden rounded-3xl border border-slate-200/70 bg-white shadow-2xl lg:grid-cols-5">
                <aside class="hidden bg-gradient-to-b from-slate-900 to-slate-800 p-10 text-white lg:col-span-2 lg:flex lg:flex-col lg:justify-between">
                    ...
                    <div class="space-y-5">
                        <p class="text-sm font-medium uppercase tracking-[0.18em] text-cyan-200">Akses Aman</p>
                        <h2 class="text-3xl font-semibold leading-tight">Konfirmasi identitas sebelum melanjutkan.</h2>
                        <p class="text-sm leading-6 text-slate-300">
                            Halaman ini melindungi fitur sensitif. Masukkan password akun untuk memverifikasi akses.
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-white/20 bg-white/5 p-4">
                        ...
                        <p class="mt-3 text-sm text-slate-200">Brand kampus konsisten pada seluruh alur autentikasi.</p>
                    </div>
                </aside>

                <section class="col-span-3 p-6 sm:p-10">
                    <div class="flex items-center justify-between gap-4">
                        <Link href="/dashboard" class="inline-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-slate-900">
                    ...
                    <div class="mt-8">
                        <p class="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">Confirm Password</p>
                        <h1 class="mt-2 text-3xl font-bold text-slate-900">Konfirmasi password akun</h1>
                        <p class="mt-3 text-sm leading-6 text-slate-600">
                            Demi keamanan, masukkan kembali password sebelum mengakses area ini.
                        </p>
                    </div>
