...
const form = useForm({
    ...
    poster_image: null,
    remove_image: false,
    event_date: toDate(props.event.event_date),
...
const posterImageUrl = computed(() => posterPreviewUrl.value || props.event.poster_image_url || null);
            ...
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <form class="space-y-6 rounded-lg bg-white p-6 shadow-sm" @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <RichTextEditor
                                ...
                                placeholder="Perbarui deskripsi agenda..."
                            />
                        </div>
                    ...
                    <div>
                        ...
                        <div v-if="posterImageUrl" class="mt-3">
                            <img
                                :src="posterImageUrl"
                        ...
                        <div v-if="props.event.poster_image_url" class="mt-3 flex items-center gap-2">
                            <Checkbox id="remove_image" v-model:checked="form.remove_image" />
                            <InputLabel for="remove_image" value="Hapus poster lama saat simpan" />
                        </div>
